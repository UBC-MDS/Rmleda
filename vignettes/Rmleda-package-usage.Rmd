...
The `autoimpute_na()` function's output is given below. Now, the `Not Available` is replaced with `Lindt` which is the most frequent value in the `chocolate_brand` column, while `NA` becomes `4` which is the mean of the `price` column values.
