...
First we install the package via GitHub

```{r installation, echo = TRUE, message= FALSE}
...
To explore the functionality of Rmleda, we will use the following fictional dataset on chocolates! The
